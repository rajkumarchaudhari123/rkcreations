  ...
  return (
    <div className="relative min-h-screen bg-[#bdd4e7] bg-gradient-to-br from-[#bdd4e7] to-[#8693ab] text-white flex flex-col items-center px-6 py-12 font-sans overflow-hidden">
      ...
      <motion.div 
        ...
        className="relative z-10 text-center max-w-5xl bg-white bg-opacity-20 backdrop-blur-lg p-12 rounded-3xl shadow-2xl border border-gray-300"
      >
      ...
      <motion.div 
        ...
        className="relative z-10 mt-12 max-w-4xl bg-white bg-opacity-20 p-10 rounded-3xl shadow-2xl border border-gray-300 backdrop-blur-md text-center"
      >
        <h2 className="text-3xl font-semibold text-gray-900">Who We Are</h2>
        <p className="mt-4 text-gray-800 text-lg">
          RK Creation is a full-stack development agency transforming ideas into scalable, high-performance digital solutions. We focus on innovation, design, and technology to create experiences that matter.
        </p>
      </motion.div>
      ...
      >
        ...
        <p className="mt-4 text-gray-800 text-lg">
          🚀 <strong>Mission:</strong> Deliver high-quality, innovative digital solutions for businesses worldwide.  
      ...
      <motion.div className="relative z-10 mt-16 text-center">
        <h2 className="text-4xl font-bold text-gray-900">Let’s Create Something Extraordinary</h2>
        <p className="text-gray-800 mt-2 text-lg">Partner with us for your next big project.</p>
